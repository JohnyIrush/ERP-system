                            ...
                            <div class="panel-body">
                                <div class="row">  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="itemname" class="form-control" id="catname" placeholder="e.g. Sciences" maxlength="50">
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea rows="5" class="form-control" id="catdescription" placeholder="e.g. Subjects include Physics, Chemistry and Biology" maxlength="150"></textarea>
                                        </div>
                                    </div><!-- form-group -->                                      
