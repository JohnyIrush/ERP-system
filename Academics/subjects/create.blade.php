                            ...
                            <div class="panel-body">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="subjectname" class="form-control" id="subjectname" placeholder="e.g. English" maxlength="50">
                                        </div>
                                    </div><!-- form-group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea rows="5" class="form-control" id="subjectdescription" placeholder="e.g. This is a compulsory language subject" maxlength="300"></textarea>
                                        </div>
                                    </div><!-- form-group -->
